...
const Link = styled.a`
  ...
  img {
    ...
    /* filter: invert(49%) sepia(0%) saturate(1307%) hue-rotate(60deg) brightness(100%) contrast(133%); */
...
const Contact = () => {
  return (
    <ContactWrapper>
      <PStyles>Email : max.ratomsky@gmail.com</PStyles>
      <PStyles>Phone : +375 25 794 62 76</PStyles>
      <div>
        <Link href="#">
          {/* <svg
            aria-hidden="true"
          ...
          <img src={LogoLinkedin} alt="React Logo" />
        </Link>
